...
class SocketHandlerBuilder(HandlerBuilder):
    def __init__(self, host: str | None = None, port: int | None = None, *, unix_path: str | None = None) -> None: ...
    ...
    def with_tls(self, domain: str | None = None, *, insecure: bool = False) -> "SocketHandlerBuilder": ...
    def with_backoff(
        self,
