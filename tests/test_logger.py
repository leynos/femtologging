...
def test_handler_gains_handle_record_after_registration() -> None:
    ...
    setattr(handler, "handle_record", late_handle_record)  # noqa: B010, TD001, TD002, TD003  # FIXME: dynamic setattr needed to test frozen dispatch — MutableHandler has no handle_record attribute
...
def test_handler_dispatch_path_frozen_at_registration() -> None:
    ...
    setattr(handler, "handle_record", initial_handle_record)  # noqa: B010, TD001, TD002, TD003  # FIXME: dynamic setattr needed to register handle_record before add_handler call
    ...
    setattr(handler, "handle_record", replacement_handle_record)  # noqa: B010, TD001, TD002, TD003  # FIXME: dynamic setattr needed to replace handle_record after registration to test frozen dispatch
...
def test_exc_info_no_deprecation_warning(
    ...
    with warnings.catch_warnings(record=True) as caught:
        ...
        setattr(mod, "CustomError", custom_cls)  # noqa: B010, TD001, TD002, TD003  # FIXME: dynamic setattr required to attach custom exception class to a synthetic module
