...
class _StrategiesModule(typ.Protocol):
    ...
    def characters(self, *, blacklist_characters: str) -> object:
...
def _entrypoint_property_cases() -> _PropertyDecorator:
    ...
    -------
    _PropertyDecorator
        Decorator that parameterizes the property test when Hypothesis is
        installed, or marks that single test as skipped while CPython 3.15 lacks
        compatible Hypothesis distributions.
