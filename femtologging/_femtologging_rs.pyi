...
class HTTPAuthConfig(TypedDict, total=False):
    """Authentication options for :class:`HTTPHandlerBuilder`.

    Supply either ``token`` for bearer authentication, or both
...
class HTTPHandlerBuilder(_NetworkHandlerBuilderBase[FemtoHTTPHandler]):
    ...
    def with_auth(self, config: HTTPAuthConfig) -> Self: ...
