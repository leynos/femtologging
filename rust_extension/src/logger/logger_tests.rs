...
// Drop-lock behaviour tests live in a separate module to respect
// the 400-line limit.
#[path = "logger_tests_drop.rs"]
mod logger_tests_drop;

// Two-phase shutdown tests are in a separate module to respect the
// 400-line limit.
#[path = "logger_tests_shutdown.rs"]
mod logger_tests_shutdown;

// Python integration tests are in a separate module to respect the
// 400-line limit.
#[cfg(feature = "python")]
